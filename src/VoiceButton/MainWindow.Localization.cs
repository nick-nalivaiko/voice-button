...
public partial class MainWindow
{
    private static readonly IReadOnlyDictionary<string, string[]> UiTexts = new Dictionary<string, string[]>
    {
        ...
        ["MinimizeToTrayHint"] = new[] { "Если включено, крестик прячет окно в трей. Кнопка «Свернуть» сворачивает окно в панель задач.", "Якщо ввімкнено, хрестик ховає вікно в трей. Кнопка «Згорнути» згортає вікно на панель завдань.", "When enabled, Close hides the window in the tray. The Minimize button sends the window to the taskbar." },
        ...
        ["ToggleLiveHotkeyLabel"] = new[] { "Пауза / продолжить live-озвучку", "Пауза / продовжити live-озвучення", "Pause / resume live narration" },
        ["ToggleLiveHotkeyHint"] = new[] { "Приостанавливает live-озвучку, сохраняя позицию и очередь абзацев.", "Призупиняє live-озвучення, зберігаючи позицію та чергу абзаців.", "Pauses live narration while preserving the position and paragraph queue." },
        ...
        ["LiveNarrationPaused"] = new[] { "Live-озвучка на паузе", "Live-озвучення на паузі", "Live narration paused" },
        ["LiveNarrationPausedDetail"] = new[] { "Позиция и очередь сохранены. Повторное нажатие продолжит озвучку.", "Позицію та чергу збережено. Повторне натискання продовжить озвучення.", "The position and queue are preserved. Press again to resume." },
        ...
        ["LiveNarrationUnavailable"] = new[] { "Live-озвучка недоступна", "Live-озвучення недоступне", "Live narration unavailable" },
    ...
    private void ApplyInterfaceLanguage()
    {
        ...
        ToggleLiveHotkeyLabelText.Text = Tr("ToggleLiveHotkeyLabel");
        ToggleLiveHotkeyHintText.Text = Tr("ToggleLiveHotkeyHint");
        ClearSpeakLatestHotkeyButton.Content = Tr("ClearHotkeyButton");
        ...
        ClearToggleLiveHotkeyButton.Content = Tr("ClearHotkeyButton");
        UpdateHotkeyButtons();
